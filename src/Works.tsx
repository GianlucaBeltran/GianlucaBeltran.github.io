      ...
      <section className="work" id="goal-wall">
        <div className="work-description">
          ...
          <p style={{ fontSize: "1.2rem" }}>
            ...
            <span style={{ fontWeight: "bold" }}>app</span> that would integrate
            into existing gym systems and allow members to{" "}
          ...
          <p style={{ fontSize: "1.2rem" }}>
            ...
            display all the goals of the gym members. It was designed to be put
            on a{" "}
            <span style={{ fontWeight: "bold" }}>big screen at the gym</span> so
            the members could look at the goals while working out.
          </p>
      ...
      <section className="work" id="research-project">
        <div className="work-description">
          ...
          <p style={{ fontSize: "1.2rem" }}>
            ...
            Using a <span style={{ fontWeight: "bold" }}>virtual reality</span>{" "}
            headset, participants were immersed in a virtual urban environment
            and were presented with{" "}
            <span style={{ fontWeight: "bold" }}>two corners</span> of a street.
            The corners were identical in terms of the buildings and the street,
            but they differed in what{" "}
            <span style={{ fontWeight: "bold" }}>street level attributes</span>{" "}
            were present. The participants were asked to choose which corner
            they would prefer to walk down. The results showed that the presence
            of street level attributes such as{" "}
            <span style={{ fontWeight: "bold" }}>
